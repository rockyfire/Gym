...
public class User implements Serializable{
	...
	private UserMessage userMessage; 	//连接用户详细信息
	private List<Role> roles = new ArrayList<>();					//用户角色
 	private List<EquipmentRent> equipmentRents = new ArrayList<>(); //器材
 	private List<GroundRent> groundRents = new ArrayList<>();		//场地
 	private List<AnnounceComment> announceComments = new ArrayList<>();//公告评论
 	private List<Announcement> announcements = new ArrayList<>(); 	//公告
